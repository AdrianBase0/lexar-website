                ...
                <div class="contact-methods">
                    <div class="info-item">
                        ...
                        <div class="info-item-text">
                            <span class="info-label"><?= $page_content['info_panel_labels']['email'] ?? 'Correo' ?></span>
                    ...
                    <div class="info-item">
                        ...
                        <div class="info-item-text">
                            <span class="info-label"><?= $page_content['info_panel_labels']['telefono'] ?? 'Atención Telefónica' ?></span>
                            <span class="info-value"><?= $content['global']['contacto_rapido']['telefono'] ?? 'En proceso de gestión' ?></span>
                        </div>
                    </div>
                    <div class="info-item">
                        <div class="info-item-icon">
                        ...
                        <div class="info-item-text">
                            <span class="info-label"><?= $page_content['info_panel_labels']['direccion'] ?? 'Sede Central' ?></span>
                ...
                <form id="contact-form" action="backend/procesar_formulario.php" method="POST" novalidate>
                    ...
                    <div class="form-grid">
                        <div class="form-group floating-group">
                            ...
                            <label for="full_name"><?= $page_content['formulario']['labels']['nombre'] ?? 'Nombre Completo' ?></label>
                        ...
                        <div class="form-group floating-group">
                            ...
                            <label for="corporate_email"><?= $page_content['formulario']['labels']['email'] ?? 'Correo' ?></label>
                        ...
                        <div class="form-group floating-group full-width">
                            ...
                            <label for="subject" class="select-label"><?= $page_content['formulario']['labels']['asunto'] ?? 'Asunto' ?></label>
                        ...
                        <div class="form-group floating-group full-width">
                            ...
                            <label for="consult_message"><?= $page_content['formulario']['labels']['mensaje'] ?? 'Mensaje' ?></label>
                        ...
                        <div class="form-group full-width checkbox-group">
                            <label class="checkbox-container">
                                ...
                                <?= $page_content['formulario']['labels']['privacidad'] ?? 'He leído y acepto la' ?> <a href="politica-privacidad.php" target="_blank">Política de Privacidad</a>
                            </label>
                            <span class="error-text" id="error-privacy_policy"></span>
                        </div>

                        <div class="form-group full-width text-right">
                            <button type="submit" class="btn btn-primary btn-block"><?= $page_content['formulario']['labels']['boton'] ?? 'Enviar Solicitud' ?></button>
                        </div>
                    </div>
